...
<template>
    <component-card title="Link Video Giới Thiệu">
      <div class="p-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div class="flex-1">
            <p class="text-sm text-gray-500">Video hướng dẫn sử dụng Tools</p>
            <p v-if="currentLink" class="text-lg font-mono text-blue-600 break-all mt-1">
              {{ currentLink }}
            </p>
            <p v-else class="text-gray-400 italic">Chưa có link video</p>
          </div>
