  ...
  <div class="p-4 md:p-6 space-y-8">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-purple-700 rounded-2xl p-8 text-white shadow-lg">
      ...
      <p class="text-lg opacity-90 mb-6 max-w-3xl">
        ...
        <strong>Copy link YouTube → Có ngay video mới bằng AI</strong>,
        <strong>Kho prompt dựng sẵn</strong>, và nhiều công cụ khác.
      </p>
    ...
    <div
      id="pricing"
      class="scroll-mt-20 bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl p-8"
    >
      <h2 class="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
        <credit-card class="w-7 h-7 text-green-600" />
      ...
      <div class="grid md:grid-cols-2 gap-8">
        ...
        <div class="w-full">
              ...
              <div class="flex justify-between items-center">
                <div class="flex-1">
                  <div class="flex items-center gap-2">
                    ...
                    <span
                      v-if="plan.popular"
                      class="bg-gradient-to-r from-purple-600 to-pink-600 text-white text-xs px-2 py-1 rounded-full font-bold"
                    >
                      PHỔ BIẾN
                    </span>
                  </div>
                  ...
                  <div
                    ...
                    class="text-xs text-green-600 font-semibold mt-1"
                  >
          ...
          <router-link to="/purchase-license">
            <button
              class="w-full mt-6 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-3 px-6 rounded-xl font-semibold shadow-lg transition-all transform hover:scale-105 flex items-center justify-center gap-2"
            >
              <shopping-cart class="w-5 h-5" />
        ...
        <div class="w-full">
          ...
          <ul class="space-y-3 text-sm text-gray-700">
            <li class="flex gap-2 bg-white rounded-lg p-4 border border-gray-200">
              <check-circle class="w-5 h-5 text-green-600 flex-shrink-0" />
    ...
    <div class="text-center py-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl">
      ...
      <p class="text-white/90 mb-6 mx-2">
        Chọn gói phù hợp và bắt đầu sử dụng công cụ ngay hôm nay!
      </p>
